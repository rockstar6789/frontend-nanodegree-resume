...
var HTMLheaderRole = '<span class=h1-role>%data%</span>';
...
var HTMLskills = '<li class="flex-item"><span class="gray-text-skills">%data%</span></li>';
...
var HTMLprojectTitle = '<a href="#">%data%</a><hr>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<p>%data%</p><br>';
...
var HTMLonlineClasses = '<h2>Post Grad Certifications</h2>';
...
function initializeMap() {
    ...
    */
    function locationFinder() {
        ...
        // adding "s" so returns the var locations[] array
        return locations;
    }
